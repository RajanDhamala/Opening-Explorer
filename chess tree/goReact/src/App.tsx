...
import "./index.css";
import { LazyLandingPage, LazyRegisterPage, LazyLoginPage, LazyTestPage, LazyListPage, LazyBoardPage, LazyPuzzlesPage, LazyCustomEvalPage } from "./LazyLoading/LazyLoading";
